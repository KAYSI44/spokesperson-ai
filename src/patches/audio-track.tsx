...
export interface AudioTrackProps
   ...
   */
  muted?: boolean;
  mediaEl: React.RefObject<HTMLAudioElement | undefined>;
}
...
export function AudioTrack({
  ...
  if (_source === undefined) {
    throw new Error(
      'The AudioTrack component expects a trackRef or source property.',
    );
  }
  ...
  const {
    ...
    {
      element: mediaEl as React.RefObject<HTMLAudioElement>,
      props,
    },
  );
  ...
  return <audio ref={mediaEl as React.RefObject<HTMLAudioElement>} {...elementProps} />;
}
